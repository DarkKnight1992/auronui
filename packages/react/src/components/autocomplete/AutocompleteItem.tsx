...
export function AutocompleteItem({ value, isDisabled, textValue, className, classNames, children }: AutocompleteItemProps) {
  ...
  return (
    ...
    >
      {({ isSelected }) => (
        <>
          <span className={composeClassName(itemTextClass, classNames?.text)} data-slot="item-text">
            {children}
          </span>
          {isSelected && (
            <span
