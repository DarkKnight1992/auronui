...
describe("CalendarYearPicker", () => {
  it("renders a 3x4 grid of years", () => {
    render(<CalendarYearPicker defaultPlaceholder={new CalendarDate(2024, 1, 1)} />);
    expect(screen.getAllByRole("gridcell")).toHaveLength(12);
  });

  it("selects a year via click", async () => {
  ...
  it("has no accessibility violations", async () => {
    const { container } = render(<CalendarYearPicker defaultPlaceholder={new CalendarDate(2024, 1, 1)} />);
