...
<template>
  <Accordion type="single" variant="surface">
...
<template>
  <Accordion type="single" :collapsible="true" size="sm" default-value="faq-1">
    <AccordionItem value="faq-1">
...
<template>
  <Accordion type="single" :collapsible="true" default-value="a">
    <AccordionItem value="a">
      <AccordionHeader>
        <AccordionTrigger>
...
<template>
  <Accordion type="single" :collapsible="true" default-value="item-1" :class-names="{ base: 'border-2 border-blue-500 rounded-lg overflow-hidden' }">
...
export const ArrayAPI: Story = {
  ...
  parameters: {
    docs: {
      source: {
        code: `<script setup>
import { Accordion } from '@auronui/vue'
</script>
